$(document).ready(function() {
    ...
    let displayDoom = function() {
      $('#destiny_track .destiny-doom').each((i, item) => {
        if (20 - doomLevel > i) {
          $(item).removeClass("doom");
        } else {
          $(item).addClass("doom");
        }
      });
    ...
    $('#destiny_track .buttons .button.minus').click(function(event) {
      if (doomLevel > 0) {
        doomLevel--;
      }
      displayDoom();
    ...
    $('#destiny_track .buttons .button.plus').click(function(event) {
      if (doomLevel < 20) {
        doomLevel++;
      }
      displayDoom();
